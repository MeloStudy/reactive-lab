...
Sometimes we need to instrument business logic manually.
...
This verifies that the custom `Observation` on our reactive pipeline correctly added the low cardinality tag `process.type=user-process`. 
